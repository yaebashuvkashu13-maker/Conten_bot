...
for f in mlbb_calibration_store.py mlbb_calibration_feed.py mlbb_continuous_worker.py \
  mlbb_youtube_shorts_ingest.py mlbb_channel_blocklist.py mlbb_hud_signals.py pubg_ui_refs_download.py \
  mlbb_health_guard.py mlbb_pipeline_health.py \
