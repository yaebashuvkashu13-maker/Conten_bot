...
def _apply_mlbb_reliable_runtime() -> None:
    ...
    defaults = {
        ...
        "MLBB_KILL_BANNER_DISCOVER_MAX_SEC": "210",
        ...
        "MLBB_VOD_MIN_PEAK_SEC": "90",
        # Fight-first: denser coverage across the match (time buckets), not only
        # the globally loudest mid-game fights.
        ...
        # One dense decode per fight (4fps × ~13.5s) replaces +3/+6 offset probes.
    ...
    force = {
        ...
        "MLBB_BANNER_FIGHT_DENSE_SCAN",
        "MLBB_BANNER_FLASH_RANK",
        "MLBB_KILL_BANNER_FIGHT_FPS",
        "MLBB_KILL_BANNER_FIGHT_BEFORE",
        "MLBB_KILL_BANNER_FIGHT_AFTER",
        "MLBB_KILL_BANNER_FIGHT_MAX_FRAMES",
        "MLBB_KILL_BANNER_FIGHT_MAX_CLASSIFY",
        ...
        "MLBB_DISCOVER_SHIP_ON_FIRST_DOUBLE",
        "MLBB_KILL_BANNER_DISCOVER_MAX_PROBES",
        "MLBB_KILL_BANNER_DISCOVER_MAX_SEC",
        "MLBB_KILL_BANNER_DISCOVER_PEAK_FULL_RETRY",
