        ...
        upsert_segment(
            {
                ...
                "start": row["start"],
                "peak_start": row.get("peak_start", 0.0),
                "fight_end": row.get("clip", {}).get("fight_end", row.get("fight_end", 0.0)),
                "input_duration": row.get("clip", {}).get("input_duration", row.get("fight_dur", 0.0)),
                "output_duration": row.get("clip", {}).get("output_duration", row.get("fight_dur", 0.0)),
                "score": row["score"],
