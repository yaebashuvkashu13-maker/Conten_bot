...
def _vod_min_sec(game: str | None = None) -> float:
    ...
    if g == "genshin":
        # Boss fight VODs are often 2–8 min dedicated clips.
        return float(os.environ.get("GENSHIN_VOD_MIN_SEC", "90"))
...
def _vod_target_dur_sec(game: str | None = None) -> float:
    ...
    if g == "genshin":
        return float(os.environ.get("GENSHIN_VOD_TARGET_DUR_SEC", "360"))
