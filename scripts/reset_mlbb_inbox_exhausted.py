#!/usr/bin/env python3
"""Re-queue inbox VODs wrongly marked exhausted (0 sends) after gate fixes."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Reset exhausted flag for inbox VODs with 0 sends")
