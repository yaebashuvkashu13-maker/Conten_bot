...
WOT_SOFTEN_L1: dict[str, str] = {
    ...
    "WOT_BRAWL_MIN_IMPACT_DENSITY": "0.045",
    "WOT_BRAWL_MIN_HIT_FLASHES": "2",
    "WOT_BRAWL_CRUISE_IMPACT_MAX": "0.042",
    "SMART_WOT_CRUISE_IMPACT_CAP": "0.055",
...
WOT_SOFTEN_L2: dict[str, str] = {
    **WOT_SOFTEN_L1,
    ...
    "WOT_BRAWL_MIN_IMPACT_DENSITY": "0.036",
    "WOT_BRAWL_MIN_HIT_FLASHES": "1",
    "WOT_BRAWL_CRUISE_IMPACT_MAX": "0.034",
    "SMART_WOT_CRUISE_IMPACT_CAP": "0.040",
...
WOT_SOFTEN_L3: dict[str, str] = {
    **WOT_SOFTEN_L2,
    "SMART_WOT_MIN_IMPACT_DENSITY": "0.030",
    "SMART_WOT_MIN_BURST_RATIO": "1.4",
    "WOT_BRAWL_MIN_IMPACT_DENSITY": "0.028",
    "WOT_BRAWL_MIN_HIT_FLASHES": "1",
    "WOT_BRAWL_CRUISE_IMPACT_MAX": "0.026",
    "SMART_WOT_CRUISE_IMPACT_CAP": "0.030",
    "PUBG_RELAX_OWNER_HEURISTICS": "1",
