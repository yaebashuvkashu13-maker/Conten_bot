...
check_env MLBB_VOD_MONTAGE 1
check_env MLBB_VOD_TRIM_RUN 1
check_env SHOOTER_VOD_MONTAGE 1
check_env SHOOTER_VOD_TRIM_RUN 1
check_env PUBG_COMBAT_MULTI_SIGNAL 1
