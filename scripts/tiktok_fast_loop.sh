...
export MASS_DOWNLOAD_WORKERS="${FAST_WORKERS:-${MASS_DOWNLOAD_WORKERS:-7}}"
export MASS_SESSION_LIMIT="${FAST_SESSION_LIMIT:-${MASS_SESSION_LIMIT:-60}}"
export MASS_DELAY_MIN="${FAST_DELAY_MIN:-${MASS_DELAY_MIN:-2.5}}"
export MASS_DELAY_MAX="${FAST_DELAY_MAX:-${MASS_DELAY_MAX:-7.5}}"
