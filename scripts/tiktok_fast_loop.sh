...
export MASS_DOWNLOAD_WORKERS="${MASS_DOWNLOAD_WORKERS:-5}"
export MASS_SESSION_LIMIT="${MASS_SESSION_LIMIT:-45}"
export MASS_DELAY_MIN="${MASS_DELAY_MIN:-4}"
export MASS_DELAY_MAX="${MASS_DELAY_MAX:-10}"
export MASS_DOWNLOAD_TARGET="${MASS_DOWNLOAD_TARGET:-5000}"
PAUSE_MIN="${FAST_PAUSE_MIN:-240}"
PAUSE_MAX="${FAST_PAUSE_MAX:-420}"
