...
def apply_owner_send_policy() -> None:
    ...
    # Singles must meet the same fight/payoff bar as montage (no weak gun-only bypass).
    os.environ.setdefault("PUBG_EARLY_PAYOFF_REJECT_SINGLES", "1")
    os.environ.setdefault("PUBG_PAYOFF_SCORE_MIN_SINGLES", "0.38")
    os.environ.setdefault("PUBG_QUALITY_SCORE_MIN_SINGLES", "0.48")
    os.environ.setdefault("PUBG_SINGLES_GUN_PAYOFF_BYPASS", "0")
    os.environ.setdefault("PUBG_SINGLES_GUN_QUALITY_BYPASS", "0")
    os.environ.setdefault("PUBG_SINGLE_MIN_GUN_DENSITY", "0.070")
    os.environ.setdefault("PUBG_CLIP_MIN_BURST_RATIO", "6.5")
    os.environ.setdefault("SHOOTER_VOD_MONTAGE_SHOOTING_ONLY", "1")
