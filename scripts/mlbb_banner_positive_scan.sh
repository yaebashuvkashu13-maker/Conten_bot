...
export MLBB_QUICK_SEND_VODS="${MLBB_QUICK_SEND_VODS:-5}"
export MLBB_QUICK_SEND_STEP_SEC="${MLBB_QUICK_SEND_STEP_SEC:-90}"
export MLBB_QUICK_SEND_MAX_FRAMES="${MLBB_QUICK_SEND_MAX_FRAMES:-12}"
