...
# Teach panels only — final VOD clip send still uses .video_bot.env SEND_STRICT.
export MLBB_BANNER_SEND_STRICT=0
export MLBB_BANNER_OCR_NO_BANNER_MIN_SIM="${MLBB_BANNER_OCR_NO_BANNER_MIN_SIM:-0.90}"
...
export MLBB_QUICK_SEND_BATCH="${MLBB_QUICK_SEND_BATCH:-10}"
export MLBB_QUICK_SEND_VODS="${MLBB_QUICK_SEND_VODS:-12}"
export MLBB_QUICK_SEND_STEP_SEC="${MLBB_QUICK_SEND_STEP_SEC:-70}"
export MLBB_QUICK_SEND_MAX_FRAMES="${MLBB_QUICK_SEND_MAX_FRAMES:-18}"
export MLBB_QUICK_SEND_T0="${MLBB_QUICK_SEND_T0:-30}"
export MLBB_QUICK_SEND_T1="${MLBB_QUICK_SEND_T1:-1800}"
export MLBB_QUICK_SEND_SEGMENT_PEAKS="${MLBB_QUICK_SEND_SEGMENT_PEAKS:-1}"
export MLBB_QUICK_SEND_MIN_SCORE="${MLBB_QUICK_SEND_MIN_SCORE:-3}"
...
export MLBB_POS_SCAN_MIN_SCORE="${MLBB_POS_SCAN_MIN_SCORE:-3}"
