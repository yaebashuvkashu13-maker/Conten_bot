...
export MLBB_BANNER_POS_POV_MATCH="${MLBB_BANNER_POS_POV_MATCH:-1}"
export MLBB_POS_SCAN_BATCH="${MLBB_POS_SCAN_BATCH:-15}"
export MLBB_POS_SCAN_VODS="${MLBB_POS_SCAN_VODS:-18}"
export MLBB_POS_SCAN_SAMPLES="${MLBB_POS_SCAN_SAMPLES:-8}"
