...
# Positive scan must stay OCR-strict — never loosen gates for cron spam.
...
export MLBB_QUICK_SEND_MIN_SCORE="${MLBB_QUICK_SEND_MIN_SCORE:-4}"
export MLBB_POS_SCAN_BATCH="${MLBB_POS_SCAN_BATCH:-10}"
...
export MLBB_POS_CAL_MIN_TIER="${MLBB_POS_CAL_MIN_TIER:-2}"
