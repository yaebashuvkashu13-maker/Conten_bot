...
export MASS_DOWNLOAD_WORKERS="${MASS_DOWNLOAD_WORKERS:-2}"
export MASS_SESSION_LIMIT="${MASS_SESSION_LIMIT:-25}"
export MASS_DELAY_MIN="${MASS_DELAY_MIN:-12}"
export MASS_DELAY_MAX="${MASS_DELAY_MAX:-35}"
