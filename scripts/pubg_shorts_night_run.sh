...
export PUBG_CALIBRATION_BATCH="${PUBG_CALIBRATION_BATCH:-5}"
export PUBG_INGEST_MAX_DOWNLOADS="${PUBG_INGEST_MAX_DOWNLOADS:-20}"
export PUBG_SHORTS_NIGHT_SLEEP_SEC="${PUBG_SHORTS_NIGHT_SLEEP_SEC:-40}"
export PUBG_METRO_GATE=1
export PUBG_SHORTS_METRO_TAG=1
