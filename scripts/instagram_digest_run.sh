...
export IG_DIGEST_SCAN_PER_SOURCE="${IG_DIGEST_SCAN_PER_SOURCE:-3}"
export IG_DIGEST_SOURCE_DELAY_SEC="${IG_DIGEST_SOURCE_DELAY_SEC:-10}"
export IG_DIGEST_POST_DELAY_SEC="${IG_DIGEST_POST_DELAY_SEC:-2.5}"
