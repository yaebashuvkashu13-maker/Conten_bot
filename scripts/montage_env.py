...
def pubg_combat_env() -> dict[str, str]:
    ...
    return {
        **passthrough_audio_env(),
        ...
        "SMART_PUBG_MIN_GUNFIRE_DENSITY": "0.068",
        "SMART_PUBG_MIN_BURST_RATIO": "5.2",
        "PUBG_COMBAT_PANN_MIN": "0.24",
        "PUBG_COMBAT_MIN_HIT_FLASH": "0.005",
        "PUBG_COMBAT_MIN_WEAPON_EDGE": "0.028",
