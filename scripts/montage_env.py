...
def pubg_combat_env() -> dict[str, str]:
    ...
    return {
        **aggressive_action_base(),
        ...
        "SMART_PUBG_GUNFIRE_PEAK_PERCENTILE": "84",
        "SMART_PUBG_MIN_GUNFIRE_DENSITY": "0.052",
        "SMART_PUBG_MIN_BURST_RATIO": "2.8",
        "SMART_PUBG_MAX_TALK_RMS": "0.038",
...
def relaxed_montage_env(profile: str) -> dict[str, str]:
    ...
    if profile == "pubg":
        return {
            ...
            "SMART_PUBG_BIN_GUNFIRE_MIN": "0.06",
            "SMART_PUBG_MIN_GUNFIRE_DENSITY": "0.040",
            "SMART_PUBG_RELAX_MIN_GUNFIRE": "0.034",
