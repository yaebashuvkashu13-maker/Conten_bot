...
for kv in MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_FEED_RESCORE=1 MLBB_OWNER_EMERGENCY=0 MLBB_OWNER_REQUIRE_SCORE=1 \
  MLBB_INGEST_ALWAYS=1 MLBB_INGEST_COOLDOWN_EMPTY_SEC=45 MLBB_INGEST_COOLDOWN_HUNGRY_SEC=60 \
  MLBB_FEED_SYNC_ASYNC=1 MLBB_INGEST_SKIP_IF_PENDING=0 \
  HIGHLIGHT_EXEMPLAR_ROOT=/root/content_bot_ml/data/highlight_exemplars \
  ...
  MLBB_FEED_FORCE_EMPTY_SEC=480 MLBB_INGEST_BACKFILL_LIMIT=0 MLBB_FEED_RE_GATE=1 \
...
export MLBB_VOD_SEARCH_LIMIT=50
