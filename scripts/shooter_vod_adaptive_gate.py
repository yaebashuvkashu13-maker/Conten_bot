...
SHOOTER_SOFTEN_L2: dict[str, str] = {
    **SHOOTER_SOFTEN_L1,
    ...
    "PUBG_COMBAT_MIN_HIT_FLASH": "0.0010",
    "PUBG_COMBAT_MIN_WEAPON_EDGE": "0.010",
    ...
    "VIRAL_SEGMENT_HOOK_MIN": "0.10",
    "VIRAL_COMBAT_HOOK_MIN": "0.02",
    "VIRAL_COMBAT_PANN_HOOK_BYPASS": "0.18",
    "VIRAL_COMBAT_PANN_HOOK_SKIP": "0.40",
    "SHOOTER_VOD_FAST_PANN_MIN": "0.10",
    "PUBG_METRO_VOD_SKIP_INTRO_SEC": "60",
}
...
SHOOTER_SOFTEN_L4: dict[str, str] = {
    **SHOOTER_SOFTEN_L3,
    ...
    "PUBG_COMBAT_FRAMES_REQUIRED": "1",
    "PUBG_COMBAT_MIN_HIT_FLASH": "0.0005",
    "PUBG_COMBAT_MIN_WEAPON_EDGE": "0.006",
    "SMART_PUBG_MIN_GUNFIRE_DENSITY": "0.032",
    "SMART_PUBG_MAX_RUN_MOTION": "0.35",
    "VIRAL_SEGMENT_HOOK_MIN": "0.04",
    "VIRAL_COMBAT_HOOK_MIN": "0.02",
    "VIRAL_COMBAT_PANN_HOOK_BYPASS": "0.12",
    ...
    "PUBG_METRO_VOD_SKIP_INTRO_SEC": "30",
}
