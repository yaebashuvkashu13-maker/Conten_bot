...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  SHOOTER_VOD_STRICT_PEAK_TRIES=4 SHOOTER_VOD_ACTION_PEAK_LIMIT=24 SHOOTER_VOD_SCORE_MAX=8 \
  PUBG_VOD_KILL_DISCOVER=1 PUBG_KILL_MIN_TIER=single PUBG_KILL_DISCOVER_MAX_PROBES=16 \
  PUBG_KILL_DISCOVER_MAX_SEC=90 \
