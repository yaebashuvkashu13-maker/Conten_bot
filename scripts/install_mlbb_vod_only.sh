...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_VOD_PIPELINE_MAX_MIN=45 MLBB_VOD_IDLE_SEC=25 \
  ...
  MLBB_BANNER_POV_MATCH=1 MLBB_BANNER_POV_MIN_SIM=0.42 MLBB_BANNER_POST_SEC=5 MLBB_BANNER_MAX_REL_POS=0.58 \
  MLBB_CLIP_COMBAT_SAMPLES=10 MLBB_CLIP_MIN_ACTIVE_RATIO=0.40 MLBB_CLIP_MIN_HUD_RATE=0.36 \
  MLBB_CLIP_WINDOW_MIN_MOTION=0.016 MLBB_CLIP_WINDOW_MIN_MINIMAP=0.007 \
  MLBB_CLIP_MIN_TAIL_MOTION=0.016 MLBB_CLIP_MIN_TAIL_MINIMAP=0.007 \
  MLBB_KILL_BANNER_DISCOVER_MAX_PROBES=72 MLBB_KILL_BANNER_DISCOVER_MAX_SEC=480 \
  MLBB_KILL_BANNER_DISCOVER_STEP=3 MLBB_VOD_HIGHLIGHT_SEND_ONE=0 MLBB_VOD_COLLECT_ONE=0 \
  MLBB_VOD_STRICT_PEAK_TRIES=16 \
  MLBB_VOD_FAST_PROBE=0 MLBB_VOD_SEED_FROM_FAST_PROBE=0 \
  ...
  MLBB_VOD_FAST_PROBE=0 GENSHIN_VOD_FAST_PROBE=1 WOT_VOD_FAST_PROBE=1 \
