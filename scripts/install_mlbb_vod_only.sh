...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_KILL_BANNER_COLOR_ONLY=0 MLBB_KILL_BANNER_SCAN_BEFORE=14 MLBB_KILL_BANNER_SCAN_AFTER=6 \
  MLBB_VOD_BANNER_PREFILTER=1 MLBB_VOD_BANNER_PREFILTER_PEAKS=8 \
    install_mlbb_vod_only.sh \
