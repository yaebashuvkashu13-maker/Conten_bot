...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_BANNER_PRE_SEC=2 MLBB_BANNER_POST_SEC=16 \
  ...
  MLBB_KILL_BANNER_COLOR_ONLY=1 MLBB_KILL_BANNER_COLOR_HINT=1 MLBB_KILL_BANNER_COLOR_MIN=0.035 \
  MLBB_VOD_BANNER_PREFILTER=1 MLBB_VOD_BANNER_PREFILTER_PEAKS=8 MLBB_VOD_BANNER_DISCOVER=1 \
  MLBB_VOD_BANNER_PRESEND=1 MLBB_VOD_BANNER_SKIP_ON_MISS=0 MLBB_VOD_MOTION_ANCHOR_OK=0 \
  MLBB_VOD_TEAMFIGHT_RANK=1 \
  MLBB_KILL_BANNER_DISCOVER_STEP=5 MLBB_KILL_BANNER_DISCOVER_MAX_PROBES=24 MLBB_KILL_BANNER_DISCOVER_MAX_SEC=150 \
  MLBB_VOD_BANNER_DISCOVER_AUTO_FULL=1 MLBB_VOD_DISCOVERY_MIN_SEC=300 MLBB_VOD_SCORE_MAX=6 \
  MLBB_VOD_BANNER_SCORE=1 MLBB_VOD_EXEMPLAR_MAX=8 \
  MLBB_VOD_ZERO_STREAK_SOFTEN=3 MLBB_VOD_ADAPTIVE_NOTIFY=1 MLBB_VOD_EXHAUST_NOTIFY=1 \
  MLBB_VOD_PRESEND_COOLDOWN_SEC=3600 MLBB_VOD_PRESEND_EXHAUST_AFTER=2 \
  MLBB_VOD_ZERO_SEND_COOLDOWN_SEC=2700 MLBB_VOD_ZERO_SEND_EXHAUST=3 \
  MLBB_VOD_FAST_FAIL_COOLDOWN_SEC=1800 \
  ...
  SHOOTER_VOD_FAST_PROBE=1 SHOOTER_VOD_FAST_PANN_MIN=0.10 SHOOTER_VOD_PREFER_RUSSIAN=1 SHOOTER_VOD_SKIP_INTELLICLIP=1 \
  SHOOTER_VOD_FULL_PASS=1 SHOOTER_VOD_FULL_PASS_MAX_SEC=1200 SHOOTER_VOD_FULL_PASS_STEP_SEC=2 \
  SHOOTER_VOD_STAGE1_FAST=0 SHOOTER_VOD_COMBAT_FAST=1 SHOOTER_VOD_COMBAT_ONLY=1 \
  SHOOTER_VOD_PARALLEL_CAP=2 PUBG_POOL_PANN_MAX_THR=0.22 \
  PUBG_VOD_PEAK_LAG_SEC=0 PUBG_FIGHT_TAIL_PAD_SEC=6 SHOOTER_VOD_VARIABLE_LENGTH=1 \
  PUBG_FIGHT_MIN_SEC=8 PUBG_FIGHT_MAX_SEC=45 \
  SHOOTER_VOD_SEND_AS_VIDEO=1 SHOOTER_VOD_AUTO_HQ_ON_YES=0 MLBB_VOD_AUTO_HQ_ON_YES=0 \
  VOD_CALIBRATION_SEND_AS_FILE=0 SHOOTER_VOD_PRESEND_AUDIT=1 \
  ...
  VPS_BRANCH=cursor/pubg-combat-fix-6cbd \
  ...
  HIGHLIGHT_MAX_PANN_PROBE=5 HIGHLIGHT_MAX_STAGE1=48 HIGHLIGHT_HEATMAP=0 \
