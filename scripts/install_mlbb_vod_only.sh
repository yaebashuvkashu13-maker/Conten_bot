...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_VOD_BANNER_PREFILTER=1 MLBB_VOD_BANNER_PREFILTER_PEAKS=16 MLBB_VOD_BANNER_DISCOVER=1 \
  MLBB_KILL_BANNER_DISCOVER_STEP=5 MLBB_KILL_BANNER_DISCOVER_MAX_PROBES=16 MLBB_KILL_BANNER_DISCOVER_MAX_SEC=120 \
  MLBB_VOD_ZERO_STREAK_SOFTEN=3 MLBB_VOD_ADAPTIVE_NOTIFY=1 MLBB_VOD_EXHAUST_NOTIFY=1 \
  MLBB_VOD_SOFT_MAX_PEAK_TRIES=8 \
  MLBB_VOD_SEGMENT_GAP_SEC=120 MLBB_VOD_LENIENT_UNIFORM=0 MLBB_VOD_TAIL_MIN_HUD_RATE=0.58 \
  MLBB_FORCE_RERENDER=1 MLBB_PRESEND_FREEZE_MIN_DUR=1.2 MLBB_PRESEND_FREEZE_MAX_START=3.0 \
  MLBB_PRESEND_MIN_MOTION=0.018 MLBB_PRESEND_MIN_MINIMAP_DELTA=0.012 \
  HIGHLIGHT_USE_OWNER_ANCHORS=1 HIGHLIGHT_CLIP_DISABLED=0 \
