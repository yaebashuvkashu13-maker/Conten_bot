...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_BANNER_POV_MATCH=1 MLBB_BANNER_POV_MIN_SIM=0.30 MLBB_BANNER_POST_SEC=5 MLBB_BANNER_MAX_REL_POS=0.58 \
  ...
  MLBB_KILL_BANNER_DISCOVER_MAX_PROBES=64 MLBB_KILL_BANNER_DISCOVER_MAX_SEC=360 \
  ...
  VOD_HEARTBEAT_INTERVAL_SEC=30 VOD_HEARTBEAT_FRESH_SEC=180 \
