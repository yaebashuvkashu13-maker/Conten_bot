...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_BANNER_FAST_DISCOVER=1 MLBB_BANNER_FAST_SHIP=1 MLBB_BANNER_FAST_MAX_PROBES=24 MLBB_BANNER_FAST_MAX_SEC=90 \
  MLBB_BANNER_FAST_STEP_SEC=18 MLBB_BANNER_FAST_SHIP_ON_FIRST=1 MLBB_BANNER_FAST_T0_SEC=60 \
  MLBB_BANNER_FAST_SHIP_MIN_VOD_SEC=480 MLBB_BANNER_FAST_SHIP_MIN_PEAK_SEC=240 \
  MLBB_BANNER_FAST_SHIP_NO_FALLBACK=1 MLBB_BANNER_FAST_DENSE_RETRY=1 MLBB_BANNER_NEG_REF_MATCH=1 \
  MLBB_BANNER_OWNER_LOGIT=1 MLBB_BANNER_OWNER_MIN_SIM=0.36 MLBB_BANNER_OWNER_CAL_MIN_SIM=0.34 \
  MLBB_BANNER_STRONG_SIM=0.55 MLBB_BANNER_STRUCT_THR=0.46 MLBB_BANNER_SOFT_SIM=0.40 \
  MLBB_BANNER_FLOOR_SIM=0.28 MLBB_BANNER_LOGIT_THR=0.42 MLBB_BANNER_NEG_WIN_GAP=0.05 \
  MLBB_BANNER_WEAK_NEG_LEAD=1 MLBB_BANNER_REF_MATCH_CAP=140 MLBB_BANNER_NEG_MATCH_CAP=80 \
  MLBB_BANNER_REF_EARLY_ACCEPT=0.62 \
  MLBB_VOD_QUALITY_MIN_SEC=480 MLBB_VOD_DISCOVER_MIN_SEC=480 \
  ...
  GENSHIN_BOSS_FULL_FIGHT=1 GENSHIN_BOSS_FIGHT_PREFER_START=1 \
  GENSHIN_BOSS_FIGHT_MIN_SEC=28 GENSHIN_BOSS_FIGHT_MAX_SEC=120 GENSHIN_BOSS_FIGHT_HARD_MAX_SEC=160 \
  GENSHIN_BOSS_FIGHT_MAX_BACK_SEC=90 GENSHIN_BOSS_FIGHT_MAX_FORWARD_SEC=100 \
  GENSHIN_BOSS_FIGHT_BAR_EXPAND=1 GENSHIN_BOSS_FIGHT_BAR_KEEP=0.22 GENSHIN_BOSS_FIGHT_BAR_STEP_SEC=2 \
  GENSHIN_BOSS_FIGHT_POST_SEC=3 GENSHIN_VOD_LEAD_SEC=2 \
  DAILY_GAME_CYCLE_ENABLED=1 \
  DAILY_GAME_STALL_ZERO_RUNS=4 DAILY_GAME_STALL_MAX_SEC=1800 DAILY_CYCLE_RUN_TIMEOUT_SEC=1800 \
...
export DAILY_CYCLE_RUN_TIMEOUT_SEC=1800
...
export SHOOTER_VOD_MIN_SEC=120
export SHOOTER_VOD_MONTAGE_MIN_VOD_SEC=120
...
for kv in \
  ...
  DAILY_CYCLE_RUN_TIMEOUT_SEC=1800 \
  SHOOTER_VOD_MAX_SEC=14400 \
  SHOOTER_VOD_MIN_SEC=120 \
