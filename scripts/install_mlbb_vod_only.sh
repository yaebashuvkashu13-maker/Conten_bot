...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  HIGHLIGHT_PARALLEL_WORKERS=3 HIGHLIGHT_WINDOW_SCORE_TIMEOUT_SEC=480 \
  HIGHLIGHT_PARALLEL_BATCH_TIMEOUT_SEC=900 MLBB_VOD_SCAN_MAX_SEC=1800 \
...
export HIGHLIGHT_WINDOW_SCORE_TIMEOUT_SEC=480
export HIGHLIGHT_PARALLEL_BATCH_TIMEOUT_SEC=900
export MLBB_VOD_SCAN_MAX_SEC=1800
