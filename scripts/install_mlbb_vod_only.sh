...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  SHOOTER_VOD_DENSE_PROBE_STEP_SEC=40 SHOOTER_VOD_DENSE_PROBE_MAX=32 \
...
# Productive shooter path — no CLIP hang, fast montage, no idle tax
...
export SHOOTER_VOD_DENSE_PROBE_MAX=32
...
for kv in \
  ...
  SHOOTER_VOD_DENSE_PROBE_MAX=32 \
