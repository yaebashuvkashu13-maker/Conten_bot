...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_VOD_SKIP_LONG_SEC=1200 MLBB_VOD_MIN_PEAK_SEC=60 \
  ...
  MLBB_KILL_BANNER_LEAD_SEC=14 \
  MLBB_VOD_BANNER_PREFILTER=1 MLBB_VOD_BANNER_PREFILTER_PEAKS=8 MLBB_VOD_BANNER_DISCOVER=1 \
  MLBB_VOD_BANNER_DISCOVER_SPIKE=1 MLBB_VOD_BANNER_DISCOVER_FULL=0 \
  MLBB_VOD_BANNER_PRESEND=1 MLBB_VOD_BANNER_SKIP_ON_MISS=1 MLBB_VOD_BANNER_HARD_PREFILTER=1 \
  MLBB_VOD_MOTION_ANCHOR_OK=0 MLBB_PRESEND_BANNER_CONTEXT=1 \
  MLBB_KILL_BANNER_DISCOVER_STEP=5 MLBB_KILL_BANNER_DISCOVER_MAX_PROBES=18 MLBB_KILL_BANNER_DISCOVER_MAX_SEC=120 \
  MLBB_KILL_BANNER_DISCOVER_PEAK_HINTS=8 MLBB_KILL_BANNER_DISCOVER_SPIKE_CAP=10 \
  MLBB_VOD_MONTAGE=1 MLBB_VOD_MONTAGE_MIN_CLIPS=2 MLBB_VOD_MONTAGE_MAX_CLIPS=4 \
  MLBB_VOD_MONTAGE_GAP_SEC=75 MLBB_VOD_MONTAGE_MIN_TIER=single \
  MLBB_VOD_TRIM_RUN=1 MLBB_VOD_MAX_ZERO_ATTEMPTS=4 \
  ...
  PUBG_COMBAT_MULTI_SIGNAL=1 PUBG_COMBAT_MIN_SIGNALS=2 \
  ...
  DAILY_GAME_GENSHIN_QUOTA=5 DAILY_GAME_WOT_QUOTA=5 \
  DAILY_MLBB_QUOTA=5 DAILY_PUBG_QUOTA=5 DAILY_STANDOFF_QUOTA=5 DAILY_GENSHIN_QUOTA=5 DAILY_WOT_QUOTA=5 \
...
install -m 755 \
  ...
  "$REPO/scripts/post_quota_montages.py" \
  "$REPO/scripts/montage_dedup.py" \
  "$REPO/scripts/mlbb_same_vod_montage_mission.py" \
...
export MLBB_VOD_MIN_PEAK_SEC=60
export MLBB_KILL_BANNER_DISCOVER_TITLE_CAP=1
export MLBB_KILL_BANNER_DISCOVER_MAX_SEC=420
