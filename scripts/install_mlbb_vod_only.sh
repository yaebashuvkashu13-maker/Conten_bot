...
for kv in MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_VOD_BATCH_MAX=1 MLBB_VOD_SEND_ONE=1 MLBB_VOD_PIPELINE_MAX_VODS=0 \
  ...
  MLBB_VOD_OWNER_EXEMPLARS=1 MLBB_VOD_SYNC_OWNER=1 MLBB_VOD_MIN_CLIP_SCORE=0.05 \
  MLBB_FIGHT_MIN_SEC=8 MLBB_FIGHT_MAX_SEC=55 MLBB_FIGHT_HARD_MAX_SEC=65 \
  MLBB_FIGHT_TRIM_LONG=0 MLBB_FIGHT_SUSTAIN_QUIET_BINS=4 \
  ...
  HIGHLIGHT_MAX_PANN_PROBE=20 HIGHLIGHT_MAX_STAGE1=28 HIGHLIGHT_HEATMAP=0 \
...
export HIGHLIGHT_MAX_PANN_PROBE=20
export HIGHLIGHT_MAX_STAGE1=28
