...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_BANNER_FAST_DISCOVER=1 MLBB_BANNER_FAST_SHIP=1 MLBB_BANNER_FAST_MAX_PROBES=10 MLBB_BANNER_FAST_MAX_SEC=75 \
  MLBB_BANNER_FAST_STEP_SEC=28 MLBB_BANNER_FAST_SHIP_ON_FIRST=1 \
