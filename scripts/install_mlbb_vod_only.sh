...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  PUBG_VOD_KILL_DISCOVER=1 PUBG_KILL_DISCOVER_SKIP_IF_SEEDS=1 PUBG_KILL_MIN_TIER=single \
  PUBG_KILL_DISCOVER_MAX_PROBES=6 PUBG_KILL_DISCOVER_MAX_SEC=35 PUBG_KILL_DISCOVER_PEAK_HINTS=4 \
