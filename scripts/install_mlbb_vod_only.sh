...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  SHOOTER_VOD_FAST_PROBE=1 SHOOTER_VOD_DENSE_ON_FAST_MISS=1 SHOOTER_VOD_PREFER_RUSSIAN=1 SHOOTER_VOD_SKIP_INTELLICLIP=1 \
...
pairs = {
    ...
    "SHOOTER_VOD_DENSE_ON_FAST_MISS": "1",
    ...
    "SHOOTER_VOD_MONTAGE_PART_MAX_SEC": "28",
    "SHOOTER_VOD_VARIABLE_LENGTH": "1",
    "SHOOTER_FIGHT_MAX_SEC": "28",
    "SHOOTER_FIGHT_HARD_MAX_SEC": "32",
    "SHOOTER_VOD_MONTAGE_GAP_SEC": "55",
    "SHOOTER_VOD_MONTAGE_SEQUENTIAL": "1",
    "SHOOTER_VOD_MONTAGE_CLUSTER_SPAN_SEC": "240",
    "SHOOTER_VOD_MONTAGE_PART_GAP_SEC": "20",
    "SHOOTER_VOD_MONTAGE_POOL_PART_GAP_SEC": "22",
    "PUBG_STYLE_RANK_BLEND": "0.58",
    "PUBG_STYLE_ROW_BLEND": "0.55",
    ...
    "PUBG_VOD_MONTAGE_MIN_FINAL_SEC": "35",
    "PUBG_VOD_SINGLE_FALLBACK": "1",
    "PUBG_VOD_SINGLES_FIRST": "1",
    "PUBG_SEGMENT_MAX_SEC": "55",
    "PUBG_SINGLE_MAX_SEC": "90",
    "PUBG_MONTAGE_PART_LONG_MAX_SEC": "45",
    "PUBG_LONG_FIGHT_MIN_SEC": "20",
    "PUBG_CLIP_MAX_LEAD_FRAC": "0.12",
    "PUBG_CLIP_MAX_PEAK_FRAC": "0.65",
    ...
    "PUBG_SEGMENT_SCAN_BEFORE": "14",
    "PUBG_SEGMENT_SCAN_AFTER": "40",
    "PUBG_SEGMENT_MIN_POST_PEAK_SEC": "16",
    "PUBG_SEGMENT_GUN_ONSET_MIN": "0.025",
    "PUBG_SEGMENT_BACKLOAD_REL": "0.45",
    "PUBG_SEGMENT_TARGET_PEAK_REL": "0.28",
    ...
    "PUBG_KILL_NOTIFICATION_MODE": "prefer",
    "PUBG_REQUIRE_KILL_NOTIFICATION": "0",
    "PUBG_KILL_NOTIFICATION_MIN_SCORE": "0.50",
    ...
    "SHOOTER_VOD_MAX_SOFTEN_LEVEL": "0",
    "PUBG_METRO_TITLE_TRUST": "1",
    "PUBG_METRO_SEGMENT_RELAX": "0",
    "PUBG_PRESEND_MIN_GUN_DENSITY": "0.045",
    "PUBG_POOL_MIN_GUN_DENSITY": "0.038",
    "SHOOTER_VOD_MIN_CLIP_SCORE": "0.10",
    "SHOOTER_VOD_MONTAGE_CLIP_MIN": "0.12",
    "SHOOTER_VOD_MONTAGE_MIN_CLIP_SCORE": "0.10",
...
install -m 755 \
  ...
  "$REPO/scripts/vod_viewport_cache.py" \
  "$REPO/scripts/vod_event_dedup.py" \
...
if [[ -f /root/data/mlbb/EU_PUBG_ONLY ]] || grep -q '^VOD_PUBG_ONLY=1' "$ENV_FILE" 2>/dev/null; then
  if ! grep -q '^export VOD_PUBG_ONLY=1' "$WRAPPER_VOD" 2>/dev/null; then
    sed -i '/export CONTENT_BOT_REPO=/a export VOD_PUBG_ONLY=1' "$WRAPPER_VOD"
  fi
fi
