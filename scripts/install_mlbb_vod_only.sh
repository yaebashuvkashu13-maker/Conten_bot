...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_BANNER_OWNER_LOGIT=1 MLBB_BANNER_OWNER_MIN_SIM=0.38 MLBB_BANNER_OWNER_CAL_MIN_SIM=0.36 \
  MLBB_BANNER_STRONG_SIM=0.55 MLBB_BANNER_STRUCT_THR=0.48 MLBB_BANNER_SOFT_SIM=0.45 \
  MLBB_BANNER_REF_MATCH_CAP=140 MLBB_BANNER_NEG_MATCH_CAP=80 MLBB_BANNER_REF_EARLY_ACCEPT=0.62 \
