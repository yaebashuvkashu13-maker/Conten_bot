...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_FIGHT_TRIM_LONG=1 MLBB_FIGHT_SUSTAIN_QUIET_BINS=4 \
  MLBB_VOD_KILL_BANNER=1 MLBB_KILL_BANNER_REQUIRED=1 MLBB_KILL_BANNER_MIN_TIER=triple \
  MLBB_KILL_BANNER_SCAN_BEFORE=14 MLBB_KILL_BANNER_SCAN_AFTER=6 \
  MLBB_VOD_SEGMENT_GAP_SEC=120 MLBB_VOD_LENIENT_UNIFORM=1 MLBB_VOD_TAIL_MIN_HUD_RATE=0.45 \
