...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  STANDOFF_VOD_MONTAGE=1 STANDOFF_VOD_MONTAGE_ONLY=1 \
  WOT_VOD_MONTAGE=1 WOT_VOD_MONTAGE_ONLY=1 \
  ...
  DAILY_MLBB_QUOTA=5 DAILY_PUBG_QUOTA=3 DAILY_STANDOFF_QUOTA=3 DAILY_GENSHIN_QUOTA=5 DAILY_WOT_QUOTA=3 \
