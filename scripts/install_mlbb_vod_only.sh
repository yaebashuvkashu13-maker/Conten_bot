...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_BANNER_FAST_DISCOVER=1 MLBB_BANNER_FAST_SHIP=0 MLBB_BANNER_FAST_MAX_PROBES=24 MLBB_BANNER_FAST_MAX_SEC=180 \
  MLBB_BANNER_FAST_STEP_SEC=28 MLBB_BANNER_FAST_SHIP_ON_FIRST=0 \
  MLBB_VOD_QUALITY_FIRST=1 MLBB_KILL_BANNER_MIN_PRE_SEC=12 MLBB_KILL_BANNER_FIGHT_PROBE_LAG=12 \
  MLBB_PRESEND_MIN_BANNER_LEAD=12 MLBB_KILL_BANNER_LEAD_SEC=12 \
  ...
  DAILY_GAME_STALL_ZERO_RUNS=4 DAILY_GAME_STALL_MAX_SEC=1800 DAILY_CYCLE_RUN_TIMEOUT_SEC=1200 \
  SHOOTER_VOD_SKIP_DISCOVERY_WHEN_INBOX_DEAD=1 SHOOTER_VOD_FAST_MONTAGE=1 \
  SHOOTER_VOD_DENSE_PROBE_STEP_SEC=40 SHOOTER_VOD_DENSE_PROBE_MAX=24 \
  ...
  SHOOTER_VOD_MONTAGE_CORE_PAD_SEC=2 SHOOTER_VOD_RECYCLE_MAX_PER_VOD=1 \
...
export DAILY_CYCLE_RUN_TIMEOUT_SEC=1200
...
export SHOOTER_VOD_DENSE_PROBE_STEP_SEC=40
export SHOOTER_VOD_DENSE_PROBE_MAX=24
...
export SHOOTER_VOD_MAX_SEC=3600
export SHOOTER_VOD_MIN_SEC=600
export SHOOTER_VOD_MONTAGE_MIN_VOD_SEC=600
...
for kv in \
  ...
  SHOOTER_VOD_DENSE_PROBE_STEP_SEC=40 \
  SHOOTER_VOD_DENSE_PROBE_MAX=24 \
