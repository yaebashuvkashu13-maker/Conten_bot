...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_VOD_BATCH_MAX=0 MLBB_VOD_SEND_ONE=0 MLBB_VOD_MAX_PER_VOD=0 \
  MLBB_VOD_INTERVAL_GAP_SEC=3 MLBB_VOD_PIPELINE_MAX_VODS=0 \
  MLBB_VOD_PIPELINE_MAX_MIN=25 MLBB_VOD_IDLE_SEC=25 \
  ...
  MLBB_VOD_KILL_BANNER=1 MLBB_KILL_BANNER_REQUIRED=0 MLBB_KILL_BANNER_MIN_TIER=single \
  MLBB_VOD_DEATH_TRIM=1 MLBB_VOD_DEATH_SKIP_PEAKS=1 MLBB_DEATH_TIMER_MAX_SEC=55 MLBB_DEATH_POST_KEEP_SEC=4 \
  MLBB_DEATH_USE_OCR=0 MLBB_DEATH_SCAN_STEP=1.2 MLBB_DEATH_MAX_PROBES=8 \
  ...
  MLBB_VOD_ZERO_STREAK_SOFTEN=3 MLBB_VOD_ADAPTIVE_NOTIFY=1 MLBB_VOD_EXHAUST_NOTIFY=1 \
  MLBB_VOD_PRESEND_EXHAUST_AFTER=3 MLBB_VOD_SCAN_COOLDOWN_SEC=3600 \
  MLBB_VOD_STAGE_TIMEOUT_SEC=900 MLBB_VOD_ANALYZE_TIMEOUT_SEC=600 \
  MLBB_VOD_RENDER_TIMEOUT_SEC=300 MLBB_VOD_FRAME_EXTRACT_TIMEOUT_SEC=30 \
  MLBB_VOD_PRESEND_TIMEOUT_SEC=180 YOUTUBE_DOWNLOAD_TIMEOUT=1200 \
  ...
  SHOOTER_VOD_SEND_ONE=1 SHOOTER_VOD_SCAN_MAX_SEC=600 SHOOTER_VOD_PRESEND_EXHAUST_AFTER=2 \
  SHOOTER_VOD_SOFT_MAX_PEAK_TRIES=3 SHOOTER_VOD_STRICT_PEAK_TRIES=3 \
  SHOOTER_VOD_FAST_MIN_HITS=2 SHOOTER_VOD_FAST_STRONG_PANN=0.40 SHOOTER_VOD_FAST_WEAK_PASS_MIN=0.18 SHOOTER_VOD_FAST_PANN_MIN=0.16 \
  SHOOTER_VOD_FAST_PROBE_MAX=8 SHOOTER_VOD_SCORE_MAX=8 SHOOTER_VOD_ACTION_PEAK_LIMIT=24 \
  SHOOTER_VOD_EXEMPLAR_MAX=12 SHOOTER_VOD_MAX_PANN_PROBE=16 SHOOTER_VOD_SEED_FROM_FAST_PROBE=1 STRICT_PROBE_LIMIT=16 \
  SHOOTER_VOD_SKIP_DISCOVERY=0 SHOOTER_VOD_COMBAT_ONLY=1 SHOOTER_VOD_COMBAT_FAST=1 SHOOTER_VOD_STAGE1_FAST=1 \
  SHOOTER_VOD_WINDOW_TIMEOUT_SEC=45 VIDEO_FRAME_IO_FORCE_FFMPEG=1 VIDEO_FRAME_IO_FFMPEG_TIMEOUT_SEC=20 \
  PUBG_PANNS_TRUST_MIN=0.28 SHOOTER_VOD_DISCOVERY_MAX_INBOX=10 SHOOTER_VOD_FORCE_FULL_SCAN_BACKLOG=8 \
  SHOOTER_VOD_REOPEN_BACKLOG=12 SHOOTER_VOD_EXHAUST_SHORT=1 \
  ...
  HIGHLIGHT_EXEMPLAR_MAX=64 MLBB_VOD_EXEMPLAR_MAX=64 \
  HIGHLIGHT_MAX_PANN_PROBE=5 HIGHLIGHT_MAX_STAGE1=12 HIGHLIGHT_HEATMAP=0 \
  HIGHLIGHT_PARALLEL_WORKERS=1 HIGHLIGHT_WINDOW_SCORE_TIMEOUT_SEC=120 \
  HIGHLIGHT_PARALLEL_BATCH_TIMEOUT_SEC=600 MLBB_VOD_SCAN_MAX_SEC=900 \
  MLBB_VOD_PARALLEL_SCORE=0 MLBB_VOD_PIPELINE_MAX_MIN=90 \
  MLBB_VOD_DEATH_SKIP_PEAKS=0 MLBB_VOD_FEED_STUCK_SEC=1200 \
  SMART_FFMPEG_THREADS=6 \
...
install -m 755 \
  ...
  "$REPO/scripts/shooter_vod_inbox.py" \
  "$REPO/scripts/shooter_vod_batch_scan.py" \
  ...
  "$REPO/scripts/mlbb_death_screen.py" \
  ...
  "$REPO/scripts/vod_stage_timeout.py" \
  "$REPO/scripts/vod_scan_state.py" \
  "$REPO/scripts/smart_video_editor.py" \
...
export HIGHLIGHT_EXEMPLAR_MAX=64
export MLBB_VOD_EXEMPLAR_MAX=64
export MLBB_VOD_SEND_ONE=0
export MLBB_VOD_PARALLEL_SCORE=0
export MLBB_VOD_PIPELINE_MAX_MIN=90
export MLBB_VOD_DEATH_SKIP_PEAKS=0
export HIGHLIGHT_MAX_PANN_PROBE=5
export HIGHLIGHT_MAX_STAGE1=12
export HIGHLIGHT_PARALLEL_WORKERS=1
export HIGHLIGHT_WINDOW_SCORE_TIMEOUT_SEC=120
export HIGHLIGHT_PARALLEL_BATCH_TIMEOUT_SEC=600
export MLBB_VOD_SCAN_MAX_SEC=900
export MLBB_VOD_PRESEND_EXHAUST_AFTER=3
export MLBB_VOD_ANALYZE_TIMEOUT_SEC=600
export YOUTUBE_DOWNLOAD_TIMEOUT=1200
export MLBB_VOD_FEED_STUCK_SEC=1200
