...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  MLBB_SHORTS_ONLY=0 MLBB_VOD_DISABLED=0 MLBB_VOD_ONLY=1 MLBB_LEARNING_FIRST=1 MLBB_SEND_ENABLED=1 \
  ...
  MLBB_USE_CLASSIFIER=0 MLBB_VOD_QUALITY_MODEL=1 MLBB_VOD_QUALITY_MODEL_REQUIRED=0 \
  ...
  MLBB_VOD_PIPELINE_MAX_MIN=45 MLBB_VOD_MAX_PROCESS_MIN=15 MLBB_VOD_IDLE_SEC=45 \
  MLBB_VOD_NO_SEND_KILL_SEC=1800 MLBB_VOD_OCR_STALL_KILL_SEC=1200 \
  MLBB_VOD_SILENCE_ALERT_SEC=7200 MLBB_VOD_CIRCUIT_ALLOW_RESET=0 \
  MLBB_RELAX_AFTER_ZERO_VODS=2 MLBB_VOD_QUALITY_MODE_RELAX=0 \
  MLBB_VOD_MIN_CLIP_SCORE_RELAX=0.02 MLBB_BANNER_MIN_HOOK_RELAX=0.04 \
  MLBB_KILL_BANNER_DENSE_MAX_SEC=240 MLBB_SAVAGE_DENSE_MAX_SPAN_SEC=300 \
  ...
  MLBB_FIGHT_MIN_SEC=8 MLBB_FIGHT_MAX_SEC=28 MLBB_FIGHT_HARD_MAX_SEC=32 MLBB_FIGHT_POST_SEC=3 \
  ...
  MLBB_KILL_BANNER_LEAD_SEC=14 MLBB_DOUBLE_BANNER_LEAD_SEC=14 \
  ...
  MLBB_VOD_BANNER_PRESEND=1 MLBB_VOD_BANNER_SKIP_ON_MISS=1 MLBB_VOD_SKIP_ON_DISCOVER_MISS=1 \
  MLBB_VOD_MOTION_ANCHOR_OK=0 \
  MLBB_BANNER_POV_MATCH=1 MLBB_BANNER_POV_RESCAN=0 MLBB_BANNER_POV_MIN_SIM=0.30 \
  MLBB_BANNER_POST_SEC=3 MLBB_BANNER_MIN_REL_POS=0.55 MLBB_BANNER_MAX_REL_POS=0.75 MLBB_BANNER_MAX_PRE_SEC=18 \
  ...
  MLBB_VOD_QUALITY_MODE=1 MLBB_VOD_BAD_SHARE_TARGET=0.20 MLBB_VOD_DISABLE_SOFTEN=0 \
  MLBB_THROUGHPUT_SILENCE_SEC=1800 MLBB_FEEDBACK_GATE_RELAX=0 \
  MLBB_KILL_BANNER_THROUGHPUT_MAX_PROBES=6 MLBB_KILL_BANNER_THROUGHPUT_MAX_SEC=60 \
  MLBB_VOD_TAIL_EXCLUDE_SEC=75 MLBB_VOD_RANK_SCREEN_SEC=90 \
  MLBB_KILL_BANNER_DISCOVER_MAX_PROBES=48 MLBB_KILL_BANNER_DISCOVER_MAX_SEC=120 \
  ...
  SHOOTER_VOD_DISABLE_SOFTEN=0 EXTENDED_VOD_DISABLE_SOFTEN=1 \
  SHOOTER_VOD_ZERO_STREAK_SOFTEN=2 SHOOTER_VOD_ADAPTIVE_NOTIFY=1 SHOOTER_VOD_EXHAUST_NOTIFY=0 \
  SHOOTER_VOD_DOWNLOAD_NOTIFY=0 SHOOTER_VOD_METRO_REJECT_NOTIFY=0 \
  SHOOTER_VOD_DISCOVERY_PAUSE_AFTER=3 SHOOTER_VOD_DISCOVERY_PAUSE_SEC=900 \
  SHOOTER_VOD_MIN_SEC=480 SHOOTER_VOD_PREF_MIN_SEC=600 SHOOTER_VOD_IDEAL_SEC=900 \
  SHOOTER_VOD_MIN_CLIP_SCORE=0.02 \
  VIRAL_COMBAT_HOOK_MIN=0.035 VIRAL_SEGMENT_HOOK_MIN=0.08 \
  ...
  SHOOTER_VOD_MAX_PANN_PROBE=16 SHOOTER_VOD_SEED_FROM_FAST_PROBE=1 \
  SHOOTER_VOD_FAST_PANN_MIN=0.10 SHOOTER_VOD_FAST_PROBE_MAX=8 SHOOTER_VOD_FAST_MIN_HITS=1 \
  SHOOTER_VOD_STRICT_PEAK_TRIES=4 SHOOTER_VOD_ACTION_PEAK_LIMIT=24 SHOOTER_VOD_SCORE_MAX=5 \
  SHOOTER_VOD_SCORE_EARLY_STOP=2 SHOOTER_VOD_ZERO_POOL_COOLDOWN_SEC=1800 \
  SHOOTER_VOD_SEED_FAST_STAGE1=1 SHOOTER_VOD_SEED_FAST_MIN=2 \
  MLBB_VOD_IDLE_SEC=45 \
  PUBG_VOD_KILL_DISCOVER=1 PUBG_VOD_KILL_DENSE_SEC=1 PUBG_KILL_DISCOVER_SKIP_IF_SEEDS=0 \
  PUBG_KILL_MIN_TIER=single PUBG_KILL_DISCOVER_STEP=1.0 \
  PUBG_KILL_DISCOVER_MAX_PROBES=120 PUBG_KILL_DISCOVER_MAX_SEC=180 PUBG_KILL_DISCOVER_PEAK_HINTS=8 \
  PUBG_KILL_DENSE_CHUNK_SEC=60 PUBG_KILL_DENSE_MAX_SPAN_SEC=480 PUBG_KILL_DENSE_STOP_ON_HITS=3 \
  ...
  DAILY_MLBB_QUOTA=5 DAILY_PUBG_QUOTA=5 DAILY_STANDOFF_QUOTA=5 \
  DAILY_GENSHIN_QUOTA=2 DAILY_WOT_QUOTA=2 \
  DAILY_GAME_MLBB_QUOTA=5 DAILY_GAME_PUBG_QUOTA=5 DAILY_GAME_STANDOFF_QUOTA=5 \
  DAILY_GAME_GENSHIN_QUOTA=2 DAILY_GAME_WOT_QUOTA=2 \
  ...
  HIGHLIGHT_PARALLEL_WORKERS=5 SMART_FFMPEG_THREADS=4 \
  MLBB_VOD_HERO_GATE=1 MLBB_SOURCE_BLOCK_MIN_VODS=3 \
  VOD_HEARTBEAT_INTERVAL_SEC=30 VOD_HEARTBEAT_FRESH_SEC=900 \
  MLBB_VOD_FEED_STUCK_SEC=2400 \
...
export MLBB_FIGHT_POST_SEC=3
export MLBB_FIGHT_TRIM_LONG=1
export MLBB_BANNER_POST_SEC=3
export MLBB_DOUBLE_BANNER_LEAD_SEC=14
export MLBB_KILL_BANNER_LEAD_SEC=14
export MLBB_BANNER_MIN_REL_POS=0.55
export MLBB_BANNER_MAX_REL_POS=0.75
...
export HIGHLIGHT_PARALLEL_WORKERS=5
