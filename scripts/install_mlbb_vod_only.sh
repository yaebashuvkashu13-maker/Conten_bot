...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_KILL_BANNER_COLOR_ONLY=1 MLBB_KILL_BANNER_SCAN_BEFORE=24 MLBB_KILL_BANNER_SCAN_AFTER=12 \
  ...
  MLBB_MOMENT_ANCHOR=banner MLBB_BANNER_ENRICH_ONLY=1 MLBB_BANNER_VISUAL_OK=1 \
  MLBB_BANNER_REF_MATCH=1 MLBB_BANNER_OWNER_REFS=1 MLBB_KILL_BANNER_COLOR_ONLY=1 \
  MLBB_FAST_PROBE_MODE=combat HIGHLIGHT_MLBB_SKIP_INTRO_SEC=120 \
