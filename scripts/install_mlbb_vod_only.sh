...
for kv in   MLBB_ONLY_MODE=1 VK_MLBB_DISABLED=1 VK_MLBB_NOTIFY_EMPTY=0 \
  ...
  MLBB_KILL_BANNER_DISCOVER_MAX_PROBES=96 MLBB_KILL_BANNER_DISCOVER_MAX_SEC=480 \
  ...
  MLBB_FEEDBACK_GATE=1 MLBB_FEEDBACK_GATE_DISCOVERY=0 MLBB_VOD_ZERO_RECOVERY_SOFTEN=8 \
  MLBB_BANNER_ANCHOR_HOOK_MIN=0.04 \
