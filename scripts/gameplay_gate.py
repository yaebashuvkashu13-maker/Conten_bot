...
from mlbb_shorts_title_gate import (
    NON_MLBB_SPORTS_TITLE,
    OTHER_GAME_TITLE,
    PROMO_PATTERNS,
    title_rejected_for_mlbb_shorts,
)
...
def segment_is_valid_for_montage(
    ...
    *,
    ...
    if profile in ("wot", "world_of_tanks"):
        ...
        if center_motion >= 0.10 and impact_density < float(
            os.environ.get(
...
def is_mlbb_calibration_short(
    ...
    *,
    ...
    title_reason = title_rejected_for_mlbb_shorts(text)
    if title_reason:
        return False, 0.0, title_reason
